...
class _HomePageState extends State<HomePage> {
  var currency = "", capital = "", flag = "";
  String place ="", code="";
  Country count = Country("Not Available", "Not Available", "https://flagsapi.com/MY/flat/64.png", "Not Available");
  TextEditingController textEditingController = TextEditingController();

  final List<Map> countriesEnglish = [
  ...
  _loadCountry() async {
    ...
    var apiid = "UXZmxkqN6vANdZIXSdl1oQ==sjyq58bDVJ3efLLP";
    var url1 = Uri.parse('https://api.api-ninjas.com/v1/country?name=$place');
    var response1 = await http.get(url1, headers:{'X-Api-Key': apiid});
    ...
    try{
      ...
      Fluttertoast.showToast(
          ...
          count = Country("Not Available", "Not Available", "https://flagsapi.com/MY/flat/64.png", "Not Available");
...
class WeaterGrid extends StatefulWidget {
  ...
  WeaterGrid({Key? key, required this.count}) : super(key: key);
...
class _WeaterGridState extends State<WeaterGrid> {
  String flag="https://flagsapi.com/code/flat/24.png";
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10), // Add some spacing between the widgets
              Text(widget.count.capital), // Display the "capital" text
            ],
          ),
          color: Colors.pink[100],
        ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10), // Add some spacing between the widgets
              Text(widget.count.currency), // Display the "currency" text
            ],
          ),
          color: Colors.pink[100],
        ),
  ...
  child: Column(
    ...
    children: [
      ...
      Image.network(widget.count.flag),
      Text(widget.count.place),
    ],
  ),
  color: Colors.pink[100],
...
String getCountry(place,countriesEnglish){
    
    String code="";
    for (int i = 0; i < countriesEnglish.length; i++) {
    if (place.toLowerCase() == countriesEnglish[i]["name"].toLowerCase()) {
      code = countriesEnglish[i]["code"];
      print(code);
    break;
    }
  }
